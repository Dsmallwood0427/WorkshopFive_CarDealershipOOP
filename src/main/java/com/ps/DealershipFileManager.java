...
public class DealershipFileManager {
    public static Dealership getDealership(){
        try{
            ...
            while((input = bufferedReader.readLine()) != null) {
                ...
                com.ps.Vehicle vehicle = new com.ps.Vehicle(vin, year, make, model, vehicleType, color, odometer, price);
    ...
    public static void saveDealership(Dealership dealership){
        try {
            ...
            List<com.ps.Vehicle> vehicles = dealership.getAllVehicles();
            for(com.ps.Vehicle vehicle: vehicles){
